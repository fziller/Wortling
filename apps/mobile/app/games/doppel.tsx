...
const styles = StyleSheet.create({
  ...
  card: { alignItems: "center", gap: tokens.space.xs, padding: tokens.space.lg, borderRadius: tokens.radius.surface, backgroundColor: tokens.surface.control },
  ...
  hints: { gap: tokens.space.xs, padding: tokens.space.sm, borderRadius: tokens.radius.control, backgroundColor: tokens.surface.control },

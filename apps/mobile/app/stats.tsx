...
const styles = StyleSheet.create({
  ...
  backButton: { alignSelf: "flex-start", paddingHorizontal: 16, paddingVertical: 8, borderWidth: 1, borderColor: tokens.color.line, borderRadius: 999, backgroundColor: "rgba(255,255,255,0.62)" },
  backButtonText: { color: tokens.color.ink, fontWeight: "900" },
  kicker: { color: tokens.color.primaryDark, fontSize: 13, fontWeight: "900", letterSpacing: 1.6, textTransform: "uppercase" },
  title: { color: tokens.color.ink, fontSize: 42, fontWeight: "900", letterSpacing: -1.8 },
  // tape card — same look as GameCard
  tapeCard: { backgroundColor: "#FFFDF8", borderColor: "#EEE6DA", borderRadius: 18, borderWidth: 1, overflow: "visible" as const, padding: 20, shadowColor: tokens.color.shadow, shadowOffset: { height: 9, width: 0 }, shadowOpacity: 0.08, shadowRadius: 18, elevation: 2 },
  tapeCardContent: { gap: 12 },
  cardTitle: { color: tokens.color.ink, fontSize: 22, fontWeight: "900" },
  sectionTitle: { color: tokens.color.ink, fontSize: 20, fontWeight: "900" },
  body: { color: tokens.color.muted, fontSize: 17, lineHeight: 24 },
  ...
  tileLabel: { color: tokens.color.muted, fontSize: 11, fontWeight: "800", letterSpacing: 0.6, textTransform: "uppercase" as const },
  tileValueBig: { color: tokens.color.ink, fontSize: 36, fontWeight: "900", letterSpacing: -1 },
  tileValue: { color: tokens.color.ink, fontSize: 22, fontWeight: "900" },

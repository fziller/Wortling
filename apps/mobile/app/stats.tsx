...
const styles = StyleSheet.create({
  ...
  title: { color: tokens.color.ink, ...tokens.typography.displayTitle },
  ...
  cardTitle: { color: tokens.color.ink, fontSize: 22, ...tokens.typography.display },
  sectionTitle: { color: tokens.color.ink, fontSize: 20, ...tokens.typography.display },
  ...
  tileValueBig: { color: tokens.color.ink, fontFamily: tokens.font.ui.bold, fontSize: 36, letterSpacing: -1, fontVariant: ["tabular-nums"] as const },
  tileValue: { color: tokens.color.ink, fontFamily: tokens.font.ui.bold, fontSize: 22, fontVariant: ["tabular-nums"] as const },
